...
Then, the **`Adult dataset`** from UCI is so interesting and big enough for our experiment. The dataset is for prediction whether a person's income exceeds $50K/yr based on census data (48,842 rows). Also known as the **`Census Income dataset`**.
